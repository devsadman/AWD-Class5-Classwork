...
<body>
    <div class="container">
    <h4 class="mt-3 text-center font-weight-bold text-danger">AWD CodersTrust Mates</h4>
        <div class="row">
    ...
    ?>
		            <div class="col-md-3 mt-4 mb-4">
		                <div class="card shadow">
		                    ...
		                    <div class="card-body">
		                        <h4 style="font-size: 16px; font-weight:bold;"><?php echo $value['name'] ?></h4>
